...
class _UserFormScreenState extends State<UserFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(title: 'Create User', isBackButton: true),
      body: Padding(
                ...
                if (widget.isRole == 'Student')
                  Expanded(
                    child: CustomDropdown(
                      labelText: 'HK Type',
                      options: ['Select HK Type', 'HK 25', 'HK 50', 'HK 75'],
              ...
              children: [
                ...
                Expanded(
                  child: CustomDropdown(
                    ...
                    options: ['Select Account Status', 'Active', 'Inactive'],
  ...
  void _handleSubmit() {
    ...
    if (widget.schoolId == null) {
      ...
      context.read<AdminBloc>().add(
            UpdateUserEvent(widget.schoolId!, newUser),
          );
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
